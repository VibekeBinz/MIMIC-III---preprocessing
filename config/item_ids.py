...
spo2_ids = [646, 220277] # 646 is pulse oximetry, 220277 is spo2 from metavision, 5636 is spo2 from carevue, 3288 is O2 sat pre proceudre which is closest to first measurement for some patients, only used to fiull in missing data gaps.
